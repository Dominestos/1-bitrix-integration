...
<?endif?>
    ...
    <input placeholder="<?=GetMessage("AUTH_LOGIN")?>" name="USER_LOGIN" value="<?=$arResult['USER_LOGIN']?>" type="text">
		...
		<input  placeholder="<?=GetMessage("AUTH_PASSWORD")?>" name="USER_PASSWORD" value="<?=$arResult['USER_PASSWORD']?>" type="password">
...
<?endif?>
  ...
  <a href="<?=$arResult["AUTH_REGISTER_URL"]?>" class="hd_signup" rel="nofollow"><?=GetMessage("AUTH_REGISTER")?></a>
  <?endif?>
    ...
    <table width="95%">
      <tr>
        ...
        <?if ($arResult["REMEMBER_OTP"] == "Y"):?>
          <input type="checkbox" id="OTP_REMEMBER_frm" name="OTP_REMEMBER" value="Y" /></td>
